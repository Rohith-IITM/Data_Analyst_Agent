...
async def receive_files_delayed_cleanup(
    questions_txt: UploadFile = File(..., alias="questions.txt", description="Text file with questions"),
    image_png: UploadFile | None = File(None, alias="image.png", description="Optional image file"),
    data_csv: UploadFile | None = File(None, alias="data.csv", description="Optional CSV dataset"),
) -> JSONResponse:
    """
    ...
    Accepts files via form fields:
    - questions.txt (required): Text file with questions
    - image.png (optional): Image file 
    - data.csv (optional): CSV dataset
    """
